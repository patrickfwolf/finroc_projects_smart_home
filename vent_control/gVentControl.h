...
public:
  ...
  tInput<rrlib::si_units::tCelsius<double>> in_temperature_speicher;
  tInput<rrlib::si_units::tCelsius<double>> in_temperature_solar;
  tInput<bool> in_solar_online;

  tOutput<bool> out_ventilation_online;
