...
#ifndef __projects__smart_home__heat_control_states__tGroundSolar_h__
#define __projects__smart_home__heat_control_states__tGroundSolar_h__
 ...
 *
 */
class tGroundSolar : public tState
{
...
public:
  ...
  tGroundSolar():
    tState(tCurrentState::eSOLAR_GROUND)
  {}

  virtual ~tGroundSolar()
  {}
  ...
  {
    return shared::tPumps(true, false, true);
  }
