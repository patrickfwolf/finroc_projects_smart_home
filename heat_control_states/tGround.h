...
#ifndef __projects__smart_home__heat_control_states_tGround_h__
#define __projects__smart_home__heat_control_states_tGround_h__
...
public:
  ...
  {
    return shared::tPumps(true, false, false);
  }
