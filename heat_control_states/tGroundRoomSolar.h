...
#ifndef __projects__smart_home__heat_control_states__tGroundRoomSolar_h__
#define __projects__smart_home__heat_control_states__tGroundRoomSolar_h__
 ...
 *
 */
class tGroundRoomSolar : public tState
{
...
public:
  ...
  tGroundRoomSolar() :
    tState(tCurrentState::eSOLAR_ROOM_GROUND)
  {}

  virtual ~tGroundRoomSolar()
  {}
  ...
  {
    return shared::tPumps(true, true, true);
  }
