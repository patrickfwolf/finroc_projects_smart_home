...
#ifndef __projects__smart_home__heat_control_states__tReady_h__
#define __projects__smart_home__heat_control_states__tReady_h__
...
public:
  ...
  {
    return shared::tPumps(false, false, false);
  }
